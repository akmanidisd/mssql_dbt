...
SELECT TABLE_SCHEMA, TABLE_NAME, COLUMN_NAME, NEW_TABLE_NAME, '_DLT_LOAD_ID',   '_DLT_LOAD_ID_NUM', 'NUMBER(18,7)' , 'TEXT'
...
INSERT INTO MS_RAW.STG_META.SF_COLUMNS
      (TABLE_SCHEMA, TABLE_NAME, COLUMN_NAME, NEW_TABLE_NAME, BASE_COLUMN_NAME, NEW_COLUMN_NAME,   NEW_COLUMN_TYPE,                   DATA_TYPE) 
SELECT TABLE_SCHEMA, TABLE_NAME, COLUMN_NAME, NEW_TABLE_NAME, '_DLT_LOAD_ID',   '_DLT_LOAD_ID_AT', 'NUMBER(18,7)::TIMESTAMP_NTZ(9)' , 'TEXT'
FROM ROL_RAW.INFORMATION_SCHEMA.COLUMNS
WHERE COLUMN_NAME = '_DLT_LOAD_ID'
  AND (TABLE_SCHEMA, TABLE_NAME) IN (SELECT TABLE_SCHEMA, TABLE_NAME 
                                       FROM MS_RAW.STG_META.SF_TABLES) 
