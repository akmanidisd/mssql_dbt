...
WHERE COLUMN_NAME = '_DLT_LOAD_ID'
  AND (TABLE_SCHEMA, TABLE_NAME) IN (SELECT SF_TABLE_SCHEMA, SF_TABLE_NAME 
                                       FROM MS_RAW.STG_META.SF_TABLES) 
  AND (TABLE_SCHEMA, TABLE_NAME, COLUMN_NAME) NOT IN (SELECT SF_TABLE_SCHEMA, SF_TABLE_NAME, SF_COLUMN_NAME
