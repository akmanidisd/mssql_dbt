...
SELECT
    ...
    NULL::TEXT             AS PRIMARY_KEY_NAME,
    NULL::TEXT             AS MASTER_TABLE_NAME,
    NULL::TEXT             AS PK_COLUMNS,
    NULL::TEXT             AS PK_TABLES,
    NULL::TEXT             AS NEW_TABLE_NAME,
    NULL::TEXT             AS NEW_PRIMARY_KEY_NAME,
    NULL::TEXT             AS NEW_PRIMARY_KEY_EXPRESSION,
    NULL::TEXT             AS NEW_PRIMARY_KEY_UNIQUE_COLUMNS,
...
-- 300
SELECT COUNT(*) FROM MS_RAW.STG_META.SF_TABLES;
...
UPDATE MS_RAW.STG_META.SF_TABLES
   SET NEW_TABLE_NAME =
       REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(
              ...
              ,'JOBS','JOB')
              ,'LANGUAGES','LANGUAGE')
              ,'LOOKUP_SKILLS_LANG_PROFICIENCY','LANGUAGE_PROFICIENCY')
...
-- TEST NAMES
SELECT TABLE_NAME, NEW_TABLE_NAME , TABLE_SCHEMA
FROM MS_RAW.STG_META.SF_TABLES
WHERE 1 = 1
